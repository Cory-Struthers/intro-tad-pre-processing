...
* **Lowercasing**: Replace all captial letters with lowercase letters. The idea is that the word "This" is no different than "this" for most projects and research questions.
...
* **Generating n-grams**: FIX - compound tokens [collocation analysis]
...
* **Maintaining document length**: FIX - 
...
FIX - CORY WILL ADD COLLOCATION ANALYSIS HERE
